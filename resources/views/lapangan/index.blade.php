                ...
                <div class="newbtn">
                    <div class="row">
                        <div class="col-8">
                            ...
                            class="fa-solid fa-file-circle-plus"></i> Tambah Data Lapangan</a></button>
                    </div>
                </div>
                <br>

                <table id="tabel-lapangan" class="table table-striped table-bordered display" width="100%" cellspacing="0">
